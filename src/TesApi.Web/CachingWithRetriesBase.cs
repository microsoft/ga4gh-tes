...
namespace TesApi.Web
{
    ...
    public abstract class CachingWithRetriesBase
    {
        ...
        /// <summary>
        /// Constructor to create common retry handlers
        /// </summary>
        /// <param name="cachingRetryHandler"></param>
        /// <param name="logger"></param>
        protected CachingWithRetriesBase(CachingRetryPolicyBuilder cachingRetryHandler, ILogger logger)
        {
        ...
        private static readonly string[] DeletionErrorFoundCodes =
        [
