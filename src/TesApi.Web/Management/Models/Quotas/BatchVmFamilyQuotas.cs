namespace TesApi.Web.Management.Models.Quotas
{
    ...
    public record BatchVmFamilyQuotas(int TotalCoreQuota, int VmFamilyQuota, int PoolQuota,
        int ActiveJobAndJobScheduleQuota, bool DedicatedCoreQuotaPerVmFamilyEnforced, string VmFamily);
