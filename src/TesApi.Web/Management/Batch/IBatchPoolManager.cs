...
namespace TesApi.Web.Management.Batch
{
    ...
    public interface IBatchPoolManager
    {
        ...
        /// <returns><see cref="CloudPool.Id"/> that identifies the created pool.</returns>
        /// <param name="cancellationToken"></param>
        Task<string> CreateBatchPoolAsync(BatchModels.Pool poolInfo, bool isPreemptable, CancellationToken cancellationToken);
