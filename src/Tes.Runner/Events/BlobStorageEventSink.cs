...
{
    public class BlobStorageEventSink(Uri storageUrl, BlobApiHttpUtils blobApiHttpUtils, ILogger<BlobStorageEventSink> logger) : EventSink(logger)
    {
        ...
        private readonly BlobApiHttpUtils blobApiHttpUtils = blobApiHttpUtils;
