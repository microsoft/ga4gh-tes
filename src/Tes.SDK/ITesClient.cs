...
namespace Tes.SDK
{
    public interface ITesClient : IDisposable
    {
        ...
        IAsyncEnumerable<TesTask> ListTasksAsync(TesView view = TesView.MINIMAL, CancellationToken cancellationToken = default, Dictionary<string, string>? tags = null, TesState? state = null, string? namePrefix = null);
    }
}
