...
ssh -o StrictHostKeyChecking=no azureuser@$VM_PUBLIC_IP "chmod +x /tmp/tes-runner && sudo /tmp/tes-runner -f /tmp/runner-task.json; echo $?" > /tmp/tes-runner-test-out-err-1.txt 2>&1 &
